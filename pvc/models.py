...
class ArtikulKomponentPVC(models.Model):
  ...
  nazvaniye_sistem =models.CharField(max_length = 50,blank=True,null=True)
  camera = models.CharField(max_length = 10,blank=True,null=True)
  kod_k_component = models.CharField(max_length = 10,blank=True,null=True)
  ...
  nakleyka_nt1 = models.CharField(max_length =5,blank=True,null=True,default='0')
  created_at =models.DateTimeField(auto_now_add=True)
  updated_at =models.DateTimeField(auto_now=True)
