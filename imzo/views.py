...
def texcartaupload(request):
    ...
    for i in range(0,df.shape[0]):
        ...
        ekstruziya ='%.2f' % float(ekstruziya) if ekstruziya !='' else '0',
        pila ='%.2f' % float(pila)if ekstruziya !='' else '0',
        strayenie ='%.2f' % float(strayenie)if ekstruziya !='' else '0',
        skm_pokras = '%.2f' % float(skm_pokras) if ekstruziya !='' else '0',
        sat_pokras ='%.2f' % float(sat_pokras) if ekstruziya !='' else '0',
        gr_pokras = '%.2f' % float(gr_pokras) if ekstruziya !='' else '0',
        skm_xim = '%.2f' % float(skm_xim) if ekstruziya !='' else '0',
        sat_xim = '%.2f' % float(sat_xim) if ekstruziya !='' else '0',
        gr_xim = '%.2f' % float(gr_xim) if ekstruziya !='' else '0',
        ruchnoy_pokraska ='%.2f' % float(ruchnoy_pokraska) if ekstruziya !='' else '0',
        sublimat ='%.2f' % float(sublimat) if ekstruziya !='' else '0',
        nakleyka = '%.2f' % float(nakleyka) if ekstruziya !='' else '0',
        kombinirovan = '%.2f' % float(kombinirovan) if ekstruziya !='' else '0',
        upakovka = '%.2f' % float(upakovka) if ekstruziya !='' else '0',
        lam_nak_upakovka ='%.2f' % float(lam_nak_upakovka ) if ekstruziya !='' else '0',
        kom_upakovka = '%.2f' % float(kom_upakovka) if ekstruziya !='' else '0'
            ).save()
