...
def texcartaupload(request):
    ...
    for i in range(0,df.shape[0]):
        ...
        покраска_SKM_белый_про_во_в_сутки_буй = df['покраска_покрасочная_линия_SKM_про_во_в_сутки_буй'][i] 
        покраска_SAT_базовый_про_во_в_сутки_буй = df['покраска_покрасочная_линия_SAT_про_во_в_сутки_буй'][i] 
        покраска_горизонтал_про_во_в_сутки_буй = df['покраска_покрасочная_линия_горизонтал_про_во_в_сутки_буй'][i]
        покраска_ручная_про_во_в_сутки_буй = df['покраска_покрасочная_линия_ручная_про_во_в_сутки_буй'][i]
