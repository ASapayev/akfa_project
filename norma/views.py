...
def add_norm_post(request):   
    ...
    for key,item in data.items():
        ...
        if not Norma.objects.filter(компонент_1 = item[1],компонент_2 = item[2],компонент_3 = item[3],артикул = item[4]).exists():
            norma  = Norma.objects.update_or_create(
                ...
                серия = item[5],
                наименование = item[6],
                внешний_периметр_профиля_мм = item[7],
                площадь_мм21 = item[8],
                площадь_мм22 = item[9],
                удельный_вес_профиля_кг_м = item[10],
                диаметр_описанной_окружности_мм = item[11],
                длина_профиля_м = item[12],
                расчетное_колво_профиля_шт = item[13],
                общий_вес_профиля_кг = item[14],
                алю_сп_6063_рас_спа_на_1000_шт_пр_кг = item[15],
                алюминиевый_сплав_6063_при_этом_балвашка = item[16],
                алю_сплав_6063_при_этом_тех_отхода1 = item[17],
                алю_сплав_6063_при_этом_тех_отхода2 = item[18],
                смазка_для_пресса_кг_графитовая = item[19],
                смазка_для_пресса_кг_пилы_хл_резки_сол = item[20],
                смазка_для_пресса_кг_горячей_резки_сол = item[21],
                смазка_для_пресса_кг_графитовые_плиты = item[22],
                хим_пг_к_окр_politeknik_кг_pol_ac_25p = item[23],
                хим_пг_к_окр_politeknik_кг_alupol_сr_51 = item[24],
                хим_пг_к_окр_politeknik_кг_alupol_ac_52 = item[25],
                пр_краситель_толщина_пк_мкм = item[26],
                порошковый_краситель_рас_кг_на_1000_пр = item[27],
                пр_краситель_при_этом_тех_отхода  = item[28],
                не_нужний = item[29],
                суб_ширина_декор_пленки_мм_зол_дуб = item[30],
                сублимация_расход_на_1000_профиль_м21 = item[31],
                суб_ширина_декор_пленки_мм_3д_313701 = item[32],
                сублимация_расход_на_1000_профиль_м22 = item[33],
                суб_ширина_декор_пленки_мм_дуб_мокко = item[34],
                сублимация_расход_на_1000_профиль_м23 = item[35],
                суб_ширина_декор_пленки_мм_3д_313702 = item[36],
                сублимация_расход_на_1000_профиль_м24 = item[37],
                молярный_скотч_ширина1_мол_скотча_мм = item[38],
                молярный_скотч_рас_на_1000_пр_шт1 = item[39],
                молярный_скотч_ширина2_мол_скотча_мм = item[40],
                молярный_скотч_рас_на_1000_пр_шт2 = item[41],
                термомост_1 = item[42],
                термомост_2 = item[43],
                термомост_3 = item[44],
                термомост_4 = item[45],
                
                ламинация_верх_a_ширина_ленты_мм = item[46],
                лам_верх_a_рас_ленты_на_1000_пр_м2 = item[47],
                ламинация_низ_b_ширина_ленты_мм = item[48],
                лам_низ_b_рас_ленты_на_1000_пр_м2 = item[49],
                
                ламинация_низ_c_ширина_ленты_мм = item[50],
                лам_низ_c_рас_ленты_на_1000_пр_м2 = item[51],
                лам_рас_праймера_на_1000_штук_пр_кг = item[52],
                лам_рас_клея_на_1000_штук_пр_кг = item[53],
                лам_рас_уп_материала_мешок_на_1000_пр = item[54],
            
                заш_пл_кг_м_akfa_верх_ширина_ленты_мм = item[55],
                заш_пл_кг_м_akfa_бк_ст_ширина_ленты_мм = item[56],
                кг_м_ak_вр_и_кг_м_ak_бк_ст_рас_лн = item[57],
                заш_пл_кг_м_akfa_низ_ширина_ленты_мм = item[58],
                заш_пл_кг_м_ak_низ_рас_лн_на_1000_пр_м2 = item[59],
            
                заш_пл_кг_м_retpen_верх_ширина_ленты_мм = item[60],
                заш_пл_кг_м_retpen_бк_ст_ширина_ленты = item[61],
                кг_м_retpen_вр_и_кг_м_retpen_бк_ст_рас = item[62],
                заш_пл_кг_м_retpen_низ_ширина_ленты_мм = item[63],
                заш_пл_кг_м_retpen_низ_рас  = item[64],
                
                заш_пл_кг_м_benkam_жл_вр_ширина_лн_мм  = item[65],
                заш_пл_кг_м_benkam_жл_бк_ст_ширина_лн = item[66],
                кг_м_bn_жл_вр_и_кг_м_bn_жл_бк_ст_рас = item[67],
                заш_пл_кг_м_benkam_жл_низ_ширина_лн_мм = item[68],
                заш_пл_кг_м_bn_жл_низ_рас = item[69],
                
                заш_пл_кг_м_голд_вр_ширина_лн_мм = item[70],
                заш_пл_кг_м_голд_бк_ст_ширина_лн_мм = item[71],
                кг_м_голд_вр_и_кг_м_голд_бк_ст_рас = item[72],
                заш_пл_кг_м_голд_низ_ширина_лн_мм = item[73],
                заш_пл_кг_м_голд_низ_рас_лн_на_1000_пр_м2 = item[74],
                
                заш_пл_кг_м_imzo_akfa_вр_ширина_лн_мм = item[75],
                заш_пл_кг_м_imzo_akfa_бк_ст_ширина_лн = item[76],
                кг_м_imzo_ak_вр_и_кг_м_imzo_ak_бк_ст = item[77],
                заш_пл_кг_м_imzo_akfa_низ_ширина_лн_мм = item[78],
                заш_пл_кг_м_imzo_ak_низ_рас = item[79],
                
                заш_пл_кг_м_без_бр_вр_ширина_лн_мм = item[80],
                заш_пл_кг_м_без_бр_бк_ст_ширина_лн_мм = item[81],
                кг_м_без_бр_вр_и_кг_м_без_бр_бк_ст_рас = item[82],
                заш_пл_кг_м_без_бр_низ_ширина_лн_мм = item[83],
                заш_пл_кг_м_без_бр_низ_рас = item[84],
                
                заш_пл_кг_м_eng_верх_ширина_ленты_мм = item[85],
                заш_пл_кг_м_eng_бк_ст_ширина_ленты_мм = item[86],
                кг_м_eng_вр_и_кг_м_eng_бк_ст_рас = item[87],
                заш_пл_кг_м_eng_низ_ширина_ленты_мм = item[88],
                заш_пл_кг_м_eng_низ_рас_лн_на_1000_пр = item[89],
                
                заш_пл_кг_м_eng_qora_вр_ширина_лн_мм = item[90],
                заш_пл_кг_м_eng_qora_бк_ст_ширина_лн_мм = item[91],
                кг_м_eng_qora_вр_и_кг_м_eng_qora_бк_ст = item[92],
                заш_пл_кг_м_eng_qora_низ_ширина_ленты = item[93],
                заш_пл_кг_м_eng_qora_низ_рас = item[94],

                уп_пол_лента_ширина_уп_ленты_мм = item[95],
                уп_пол_лн_рас_уп_лн_на_1000_штук_кг = item[96],
                бумага_расход_упоковочной_ленты_на_1000_штук_кг =item[97],
                расход_скотча_ширина_скотча_мм = item[98],
                рас_скотча_рас_скотча_на_1000_штук_шт = item[99],
                упаковка_колво_профилей_в_1_пачке = item[100],
                ala7_oddiy_ala8_qora_алю_сплав_6064 = item[101],
                алю_сплав_биллетов_102_178 =item[102]
            )
        else:
...
def kombinirovaniy_process(request,id):
    ...
    norma_list,kraska_list,accessuar,nakleyka_iskyuch,zakalka_iskyuchenie = norma_for_list()
...
def norma_for_list():
        ...
        return normass,kraskas,accessuar,nakleyka,zakalka
