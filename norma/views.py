...
@login_required(login_url='/accounts/login/')
@allowed_users(allowed_roles=['admin','moderator','user1','user_accessuar','only_razlovka','razlovka','radiator','epdm','kraska','universal_user','matrix'])
...
@login_required(login_url='/accounts/login/')
@allowed_users(allowed_roles=['admin','moderator','user1','user_accessuar','only_razlovka','universal_user'])
