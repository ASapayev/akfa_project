...
########################## 1.txt ##############################
    ...
    d1['BRGEW']=[math.ceil(float(k1.replace(',','.'))) for k1 in umumiy_without_duplicate1201[9]]
    d1['NTGEW']=[math.ceil(float(k2.replace(',','.'))) for k2 in umumiy_without_duplicate1201[10]]
...
########################## 2.txt ##############################
    ...
    d2['STPRS']=[math.ceil(float(n.replace(',','.'))) for n in umumiy_without_duplicate[39]]
